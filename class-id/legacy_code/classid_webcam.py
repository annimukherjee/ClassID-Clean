...
TRACK_CONFIG     = os.path.join(SOURCE_DIR,
    'configs/mmlab/ocsort_yolox_x_crowdhuman_mot17-private-half.py')
print(f"[INFO] Using tracking config: {TRACK_CONFIG}")
TRACK_CHECKPOINT = os.path.join(SOURCE_DIR,
    'models/mmlab/ocsort_yolox_x_crowdhuman_mot17-private-half_20220813_101618-fe150582.pth')
...
OUTPUT_DIR = 'cache/tracking_singlethread_webcam'
